...
- Create Angular project with ng: `ng new lovarda-nyilvantartas-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`lovarda-nyilvantartas-angular.client.esproj`).
